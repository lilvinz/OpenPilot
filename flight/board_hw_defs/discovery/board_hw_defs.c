...
/* uart 1, 4 and 5 are RX only and available */
...
static const struct pios_dsm_cfg pios_dsm_usart2_cfg = {
	.bind = {
		.gpio = GPIOA,
		.init = {
			.GPIO_Pin   = GPIO_Pin_3,
...
static const struct pios_dsm_cfg pios_dsm_usart3_cfg = {
	.bind = {
		.gpio = GPIOB,
		.init = {
			.GPIO_Pin   = GPIO_Pin_11,
...
//Timers used for outputs (2, 4, 8, 9)
...
static const struct pios_tim_clock_cfg tim_8_cfg = {
	...
	.irq = {
		.init = {
			.NVIC_IRQChannel                   = TIM8_UP_TIM13_IRQn,	//TODO: no idea if this interrupt is right
			.NVIC_IRQChannelPreemptionPriority = PIOS_IRQ_PRIO_MID,
			.NVIC_IRQChannelSubPriority        = 0,
			.NVIC_IRQChannelCmd                = ENABLE,
		},
...
// Timers used for inputs (1 and 3)
